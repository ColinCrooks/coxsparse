...
void cox_reg_sparse_parallel(List modeldata, IntegerVector obs_in, DoubleVector coval_in, DoubleVector weights_in, IntegerVector timein_in, IntegerVector timeout_in, IntegerVector Outcomes_in, NumericVector covstart_in, NumericVector covend_in, IntegerVector idn_in, IntegerVector idstart_in, IntegerVector idend_in, double lambda, double theta_in, int MSTEP_MAX_ITER, double MAX_EPS, long unsigned int threadn);
RcppExport SEXP _coxsparse_cox_reg_sparse_parallel(SEXP modeldataSEXP, SEXP obs_inSEXP, SEXP coval_inSEXP, SEXP weights_inSEXP, SEXP timein_inSEXP, SEXP timeout_inSEXP, SEXP Outcomes_inSEXP, SEXP covstart_inSEXP, SEXP covend_inSEXP, SEXP idn_inSEXP, SEXP idstart_inSEXP, SEXP idend_inSEXP, SEXP lambdaSEXP, SEXP theta_inSEXP, SEXP MSTEP_MAX_ITERSEXP, SEXP MAX_EPSSEXP, SEXP threadnSEXP) {
BEGIN_RCPP
    ...
    cox_reg_sparse_parallel(modeldata, obs_in, coval_in, weights_in, timein_in, timeout_in, Outcomes_in, covstart_in, covend_in, idn_in, idstart_in, idend_in, lambda, theta_in, MSTEP_MAX_ITER, MAX_EPS, threadn);
    return R_NilValue;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type MAX_EPS(MAX_EPSSEXP);
    Rcpp::traits::input_parameter< long unsigned int >::type threadn(threadnSEXP);
    cox_reg_sparse_parallel_TV(modeldata, obs_in, coval_in, weights_in, timein_in, timeout_in, Outcomes_in, covstart_in, covend_in, id_in, idn_in, idstart_in, idend_in, bspl_in, tvbeta_spl_in, lambda, theta_in, MSTEP_MAX_ITER, MAX_EPS, threadn);
    return R_NilValue;
END_RCPP
}
// predictrisk
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(predictrisk(beta_in, obs_in, coval_in, frailty_in, timein_in, weights_in, timeout_in, Outcomes_in, covstart_in, covend_in, idn_in, idstart_in, idend_in, threadn));
    return rcpp_result_gen;
END_RCPP
}
// profile_ci
NumericMatrix profile_ci(DoubleVector beta_in, IntegerVector obs_in, DoubleVector coval_in, DoubleVector weights_in, DoubleVector frailty_in, IntegerVector timein_in, IntegerVector timeout_in, IntegerVector Outcomes_in, NumericVector covstart_in, NumericVector covend_in, IntegerVector idn_in, IntegerVector idstart_in, IntegerVector idend_in, double lambda, double theta_in, int MSTEP_MAX_ITER, int decimals, double confint_width, int threadn);
RcppExport SEXP _coxsparse_profile_ci(SEXP beta_inSEXP, SEXP obs_inSEXP, SEXP coval_inSEXP, SEXP weights_inSEXP, SEXP frailty_inSEXP, SEXP timein_inSEXP, SEXP timeout_inSEXP, SEXP Outcomes_inSEXP, SEXP covstart_inSEXP, SEXP covend_inSEXP, SEXP idn_inSEXP, SEXP idstart_inSEXP, SEXP idend_inSEXP, SEXP lambdaSEXP, SEXP theta_inSEXP, SEXP MSTEP_MAX_ITERSEXP, SEXP decimalsSEXP, SEXP confint_widthSEXP, SEXP threadnSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< DoubleVector >::type beta_in(beta_inSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type threadn(threadnSEXP);
    rcpp_result_gen = Rcpp::wrap(profile_ci(beta_in, obs_in, coval_in, weights_in, frailty_in, timein_in, timeout_in, Outcomes_in, covstart_in, covend_in, idn_in, idstart_in, idend_in, lambda, theta_in, MSTEP_MAX_ITER, decimals, confint_width, threadn));
    return rcpp_result_gen;
END_RCPP
}
// safelog
