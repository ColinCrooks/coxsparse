...
#' @export
cox_reg_sparse_hess <- function(obs_in, coval_in, weights_in, timein_in, timeout_in, Outcomes_in, OutcomeTotals_in, OutcomeTotalTimes_in, cov_in, id_in, lambda, theta_in, MSTEP_MAX_ITER, MAX_EPS, threadn) {
    .Call('_coxsparse_cox_reg_sparse_hess', PACKAGE = 'coxsparse', obs_in, coval_in, weights_in, timein_in, timeout_in, Outcomes_in, OutcomeTotals_in, OutcomeTotalTimes_in, cov_in, id_in, lambda, theta_in, MSTEP_MAX_ITER, MAX_EPS, threadn)
}
